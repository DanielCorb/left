      ...
      <div className="flex flex-col">
        ...
        <div className="flex lg:flex-row flex-col lg:gap-16">
          <p className="text-lg lg:w-2/3 lg:mb-20 mb-10">
            ...
            mai avea nici sindicate, pentru că deciziile vor aparține
            oamenilor.Suntem însă departe de acest obiectiv, cât timp regimul
            politic actual nu a rezolvat nici măcar antagonismul primar născut
            odată cu extinderea sistemului capitalist, acela dintre deținătorii
            ...
            sistem politic bine antrenat în a mima reprezentarea
            cetăţenească.Poziția Sistemului în societate, pe cât de puternică în
            aparenţă, pe atât de fragilă este în realitate, în condiţiile în
            care ei au nevoie de o validare periodică prin alegeri din partea
            cetățenilor, de aceea se acordă o atenţie majoră eliminarii “din
            fașă” a oricărui nucleu organizat al cetățenilor care doresc să
            ...
            unor proiecte utopice.Persoanele cu expertiză, experiența și viziune
            trebuie sa devină formatori și lideri de opinie, nu șefi și
